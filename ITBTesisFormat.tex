...
\renewcommand{\contentsname}{
	\chapter*{\vspace{20pt}\daftarisi}
	\vspace{-.5em}
	\addcontentsline{toc}{chapter}{\daftarisi}
}}

\newcommand{\listappendixname}{
	\chapter*{\vspace{20pt}\tupdaftarlampiran}
	\vspace{-.5em}
...
\renewcommand{\listfigurename}{
	\chapter*{\vspace{20pt}\daftargambar}
	\vspace{-.5em}
...
\renewcommand{\listtablename}{
	\chapter*{\vspace{20pt}\daftartabel}
	\vspace{-.5em}
...
\setlength{\cftsubsubsecindent}{10.7em}

\renewcommand{\cftchappresnum}{Bab\space}

%% Set chapter name to Bab.
\titleformat{\chapter}[hang]
{\bfseries\large\centering\vspace{-2em}}
{Bab \thechapter}
{1em}
{}
