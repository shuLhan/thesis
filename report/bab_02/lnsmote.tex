...
\textcite{han2005borderline} dengan menggunakan metode bernama
...
LNSMOTE \parencite{maciejewski2011local} yang menggunakan modifikasi dari
pendekatan \textit{Safe-Level SMOTE} \parencite{bunkhumpornpat2009safe}.
